...
function ContactUs() {
  return (
    <div className="relative isolate bg-black pt-[74px] pb-[60px]">
      <iframe
        height="450"
        loading="lazy"
        allowFullScreen
      ...
      <section className="flex items-center gap-7 bg-chaos-black py-10 pl-16 ">
        <Image src={logo} alt="logo" height={76} />
        <div className="self-stretch border-r border-light-red" />
        <div className="text-xl text-white">
          <p>台中市烏日區溪福路一巷110弄105-9號</p>
          <p>04-2335 6118</p>
        </div>
      </section>
      <section className="flex justify-center pt-14 pb-24">
        <form className="grid gap-3 text-lg text-white">
          ...
          <button className="h mt-2.5 w-[495px] justify-self-end border border-white/[0.35] bg-button py-2 hover:bg-button-hover">
            送出
          </button>
        </form>
      </section>
  ...
  return (
    <label className="flex items-start gap-5">
      ...
      <Input
        ...
        className="w-[495px] border border-white/[0.15] bg-matt-black py-2.5 px-4 placeholder:text-white/20"
        rows={3}
      />
    </label>
  );
