  ...
  return (
    <article className="flex-1">
      <div className="mb-5 w-fit">
        ...
        <h2 className="border-t border-b border-light-red pb-1 pt-0.5 text-2xl font-bold text-white">
          機械規格
        </h2>
      ...
      <Section title="加工性能" items={sectionTwoItems} />
      <Section title="機台尺寸" items={sectionThreeItems} />
    </article>
  );
}
