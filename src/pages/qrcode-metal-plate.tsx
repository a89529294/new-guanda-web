    ...
    <div className="relative isolate bg-aswad-black sm:bg-black ">
      ...
      <section className="bg-chaos-black px-14 pt-20 pb-28 sm:px-0 sm:py-10 ">
        ...
        <article className="mb-24 grid gap-4 border-y sm:gap-0 sm:border-0">
          ...
          {/* 構件標記的重要性（一） ROW ONE MOBILE*/}
          <div className="hidden bg-chaos-black sm:block">
            ...
            <div className="flex flex-col justify-between text-white sm:p-6">
              <ul className="grid gap-4">
              ...
              <div className="mt-3 flex items-start gap-2.5 text-left text-lg">
                <Image
                  src={doubleDownArrows}
                  alt="decoration"
                  className="translate-y-2 sm:w-5 sm:shrink-0"
                />
                <p>烙印、電焊寫字的方式，現場尋料極為不便之情況，導致人員與吊車成本的增加。</p>
                <Image
                  src={doubleDownArrows}
                  alt="decoration"
                  className="translate-y-2 sm:w-5 sm:shrink-0"
          ...
          <div className="flex gap-4 sm:flex-col">
            <div className="relative w-3/5 shrink-0 sm:w-full">
            ...
            <div className="grid content-start gap-7 pt-5 sm:px-6 sm:pb-10">
              <div className="flex gap-2.5 text-2xl text-white">
                <RedCircleLabel>C</RedCircleLabel>
                號碼牌
              </div>
              <div className="flex items-start gap-2.5 bg-white/[0.07] p-5 sm:bg-inherit sm:p-0">
                <Image
                  src={doubleUpArrows}
                  alt="decoration"
                  className="translate-y-2 sm:w-5 sm:shrink-0"
        ...
        <div className="bg-black px-5 pt-14">
          <SandwitchedText fontSize="lg">構件標記的重要性（二）</SandwitchedText>
          <div className="mt-14 grid grid-cols-[auto_auto] gap-8 bg-white/[0.07] p-4 text-white sm:mt-5 sm:grid-cols-1">
            <div className="flex flex-col justify-between sm:gap-6">
              <SquareListItem
                title="標記的優點"
              ...
              <SquareListItem
                ...
                items={[
                  <>
                    ...
                    <br />
                    <span className="ml-6 text-lg text-bright-light-green sm:ml-0 sm:text-base">
                      5.2元/分鐘
                    </span>
                  </>,
                  "構件編號：5個字體/支",
