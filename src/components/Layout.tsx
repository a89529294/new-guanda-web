    ...
    <div className={className}>
      <nav className="flex bg-[#181A1D] ">
        ...
        <div className="flex-1 relative pr-10 bg-white/30 [clip-path:polygon(95px_0,100%_0,100%_100%,0_100%)]">
          <div className="absolute flex inset-0 left-[1px] pr-10 bg-[#101010] [clip-path:polygon(95px_0,100%_0,100%_100%,0_100%)] pl-32 pt-8">
...
function MyLink({ className, page }: { className?: string; page: LinkProp }) {
  return (
    <li className={cx("flex flex-col text-white", className)}>
      ...
      <span className="mt-auto peer-hover:h-[3px] bg-[#2AFD58]" />
    </li>
  );
}
